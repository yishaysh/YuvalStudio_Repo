      ...
      <section className="relative h-[90vh] flex items-center justify-center">
        ...
        <div className="absolute inset-0 z-0 overflow-hidden">
          <SmartImage
            ...
            alt="אווירת סטודיו יובל פירסינג בוטיק"
              ...
              {showStyleMatcher && (
                <Link to="/style-matcher">
                  <Button variant="outline" className="min-w-[180px] text-lg py-4 border-brand-primary/50 text-brand-primary bg-brand-primary/5 hover:bg-brand-primary/10 flex items-center justify-center gap-2">
                    <Sparkles className="w-5 h-5" aria-hidden="true" /> סטייל מאצ'ר
                  </Button>
                </Link>
              )}
            </div>
            ...
            {!user && (
              ...
              >
                <button 
                  ...
                  className="flex items-center gap-2 text-sm text-slate-400 hover:text-white transition-colors bg-white/5 hover:bg-white/10 px-4 py-2 rounded-full border border-white/10 focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-primary"
                >
